  ...
  <div>
    ...
    <el-form :inline="true">
      <el-form-item label="专栏ID">
        <el-input v-model="searchMap.columnid" placeholder="专栏ID"></el-input>
      </el-form-item>
      ...
      <el-form-item label="文章封面">
        <el-input v-model="searchMap.image" placeholder="文章封面"></el-input>
      </el-form-item>
      <el-form-item label="发表日期">
        <el-input v-model="searchMap.createtime" placeholder="发表日期"></el-input>
      </el-form-item>
      <el-form-item label="修改日期">
        <el-input v-model="searchMap.updatetime" placeholder="修改日期"></el-input>
      </el-form-item>
      <el-form-item label="是否公开">
        <el-input v-model="searchMap.ispublic" placeholder="是否公开"></el-input>
      </el-form-item>
      <el-form-item label="是否置顶">
        <el-input v-model="searchMap.istop" placeholder="是否置顶"></el-input>
      </el-form-item>
      <el-form-item label="浏览量">
        <el-input v-model="searchMap.visits" placeholder="浏览量"></el-input>
      </el-form-item>
      <el-form-item label="点赞数">
        <el-input v-model="searchMap.thumbup" placeholder="点赞数"></el-input>
      </el-form-item>
      <el-form-item label="评论数">
        <el-input v-model="searchMap.comment" placeholder="评论数"></el-input>
      </el-form-item>
    ...
    <el-table :data="list" border style="width: 100%">
      ...
      <el-table-column prop="content" label="文章正文" width="120"></el-table-column>
