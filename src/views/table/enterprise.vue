<template>
  <div>
    ...
    <el-table :data="list" border style="width: 100%">
      ...
      <el-table-column prop="summary" label="企业简介" width="180"></el-table-column>
    ...
    <el-dialog title="编辑" :visible.sync="dialogFormVisible">
      <el-form label-width="80px">
        ...
        <el-form-item label="是否热门">
          <el-switch v-model="pojo.ishot" placeholder="是否热门" active-value="1" inactive-value="0"></el-switch>
        </el-form-item>
