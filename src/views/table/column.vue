<template>
  <div>
    ...
    <el-table :data="list" border style="width: 100%">
      ...
      <el-table-column prop="summary" label="专栏简介" width="280"></el-table-column>
      <el-table-column prop="userid" label="用户ID" width="80"></el-table-column>
      <el-table-column prop="createtime" label="申请日期" width="180"></el-table-column>
      <el-table-column prop="checktime" label="审核日期" width="180"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleExamine(id) {
      this.$confirm('确定要审核此记录嘛？', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {
        columnApi.examine(id).then(res => {
          this.$message({
            message: res.message,
